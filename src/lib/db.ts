...
export const STORE_GROUPS = {
  physical: ["ALMAZA", "ATCFC", "ATMADI", "CCA", "CF-HOS", "CSTARS", "DUTY FREE", "FOUR SEASO", "GO SPORT1", "MOA", "MOE", "P90", "SPINNEYS"],
  online: ["AMAZON", "AMAZON BAN", "AMAZON KAM", "JUMIA", "NOON", "ONLINE"],
  ho: ["HO"],
};
